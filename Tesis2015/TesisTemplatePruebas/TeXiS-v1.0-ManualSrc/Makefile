...
clean:
	...
	@if [ -d Imagenes/Vectorial ]; then cd Imagenes/Vectorial; make clean; fi
...
distclean: clean
	...
	@if [ -d Imagenes/Vectorial ]; then cd Imagenes/Vectorial; make distclean; fi
